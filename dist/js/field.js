...
Nova.booting(function (Vue, router, store) {
    ...
    Vue.component('edit-image', __webpack_require__(12));
            ...
            [
              _vm._l(_vm.files, function(file) {
                return _vm.multiple
                  ? _c("uploaded-file", {
                      key: file,
                      attrs: { file: file.data }
                    })
                  : _vm._e()
              }),
              _vm._v(" "),
              !_vm.multiple
                ? _c("uploaded-file", { attrs: { file: _vm.files[0].data } })
                : _vm._e()
            ],
            2
          )
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(2)("5e25acc6", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../../node_modules/css-loader/index.js!../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-4f000b16\",\"scoped\":true,\"hasInlineConfig\":true}!../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./EditImage.vue", function() {
     var newContent = require("!!../../../node_modules/css-loader/index.js!../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-4f000b16\",\"scoped\":true,\"hasInlineConfig\":true}!../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./EditImage.vue");
     if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
     update(newContent);
   });
 }
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(2)("e5d016e6", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../../node_modules/css-loader/index.js!../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-c023248a\",\"scoped\":false,\"hasInlineConfig\":true}!../../../node_modules/sass-loader/lib/loader.js!../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./FormField.vue", function() {
     var newContent = require("!!../../../node_modules/css-loader/index.js!../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-c023248a\",\"scoped\":false,\"hasInlineConfig\":true}!../../../node_modules/sass-loader/lib/loader.js!../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./FormField.vue");
     if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
     update(newContent);
   });
 }
...
// module
exports.push([module.i, "\n@-webkit-keyframes pulse {\n0% {\n    opacity: 1;\n}\n50% {\n    opacity: .4;\n}\n100% {\n    opacity: 1;\n}\n}\n@keyframes pulse {\n0% {\n    opacity: 1;\n}\n50% {\n    opacity: .4;\n}\n100% {\n    opacity: 1;\n}\n}\n.preview-container {\n  margin-bottom: 20px;\n}\n.empty-message {\n  position: absolute;\n  top: 50%;\n  left: 50%;\n  -webkit-transform: translate(-50%, -50%);\n          transform: translate(-50%, -50%);\n  width: 100%;\n  text-align: center;\n  color: #7c858e;\n}\n#media-dropzone {\n  position: relative;\n  display: -webkit-box;\n  display: -ms-flexbox;\n  display: flex;\n  min-height: 300px;\n}\n#media-dropzone .img-collection {\n    width: calc(100% - 274px);\n    display: -webkit-box;\n    display: -ms-flexbox;\n    display: flex;\n    margin-left: -5px;\n    -ms-flex-wrap: wrap;\n        flex-wrap: wrap;\n    overflow-y: auto;\n    max-height: 480px;\n    position: relative;\n}\n#media-dropzone .img-collection::-webkit-scrollbar-track {\n      -webkit-box-shadow: inset 0 0 6px rgba(0, 0, 0, 0.1);\n      background-color: #fff;\n      border-radius: 3px;\n}\n#media-dropzone .img-collection::-webkit-scrollbar {\n      width: 6px;\n      border-radius: 3px;\n}\n#media-dropzone .img-collection::-webkit-scrollbar-thumb {\n      background-color: rgba(0, 0, 0, 0.1);\n      border-radius: 3px;\n}\n#media-dropzone .img-collection .uploaded-file {\n      margin: 5px;\n}\n#media-dropzone .image-editor {\n    width: 295px;\n    border-left: 1px dashed rgba(0, 0, 0, 0.1);\n    margin-left: 5px;\n}\n#media-dropzone .input-dropzone-wrap {\n    position: absolute;\n    width: 100%;\n    height: 100%;\n    border: 1px dashed rgba(0, 0, 0, 0.4);\n    background-color: #fff;\n    top: 0;\n    left: 0;\n    display: -webkit-box;\n    display: -ms-flexbox;\n    display: flex;\n    -webkit-box-pack: center;\n        -ms-flex-pack: center;\n            justify-content: center;\n    -ms-flex-line-pack: center;\n        align-content: center;\n    -webkit-box-align: center;\n        -ms-flex-align: center;\n            align-items: center;\n    opacity: 0;\n    visibility: hidden;\n}\n#media-dropzone .input-dropzone-wrap p {\n      text-align: center;\n      color: #7c858e;\n      line-height: 18px;\n      margin: 0;\n}\n#media-dropzone .input-dropzone-wrap.visible {\n      opacity: 1;\n      visibility: visible;\n}\n#media-dropzone .input-dropzone-wrap.pulse {\n      opacity: 1;\n}\n#media-dropzone .input-dropzone-wrap.pulse p {\n        -webkit-animation: pulse 1s infinite;\n                animation: pulse 1s infinite;\n}\n#media-dropzone .input-dropzone {\n    opacity: 0;\n    width: 100%;\n    height: 100%;\n    position: absolute;\n    top: 0;\n    left: 0;\n}\n", ""]);
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_laravel_nova__ = __webpack_require__(37);
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    dropEventListener: function dropEventListener(e) {
      ...
      try {
        for (var _iterator = Object.keys(e.dataTransfer.files)[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
    ...
    setEndDrag: Object(__WEBPACK_IMPORTED_MODULE_1__debounce__["a" /* default */])(function () {
    ...
    updateMedia: Object(__WEBPACK_IMPORTED_MODULE_1__debounce__["a" /* default */])(function () {
      if (window.mediaLibrary.onload.length) {
        ...
        try {
          for (var _iterator2 = window.mediaLibrary.onload[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
            var cb = _step2.value;
    ...
    toggleFileSelect: function toggleFileSelect(file) {
      ...
      if (this.multipleSelect && !this.selectedFiles.find(function (item) {
        return item.processed && item.data.id === file.data.id;
      })) {
        this.selectedFiles.push(file);
      } else if (this.multipleSelect && this.selectedFiles.find(function (item) {
        return item.processed && item.data.id === file.data.id;
      })) {
        var i = this.selectedFiles.findIndex(function (item) {
          return item.processed && +item.data.id === +file.data.id;
        });
                      ...
                      _c(
                        ...
                        [
                          _c(
                            "div",
                            {
                              staticClass: "flex flex-wrap justify-between mb-6"
                            },
                            [
                              _c(
                                "h2",
                                { staticClass: " text-90 font-normal text-xl" },
                                ...
                                [
                                  ...
                                  _vm._l(_vm.files, function(file) {
                                    return _c("uploaded-file", {
                                      ...
                                      attrs: {
                                        selected:
                                          _vm.selectedFiles.find(function(
                                            item
                                          ) {
                                            return (
                                              item.processed &&
                              ...
                              _c(
                                "div",
                                {
                                  class:
                                    ...
                                    " " +
                                    (_vm.draggingFile &&
                                    !_vm.draggingOverDropzone
                                      ? "pulse"
                                      : "")
                                },
                                [
                                  _c("p", [
                                    _vm._v("Drag and drop your files here!")
                                  ]),
                                  _vm._v(" "),
                                  _c("input", {
            ...
            _c(
              ...
              [
                _c("span", [
                  _vm._v(
                    "\n                        " +
                      _vm._s(_vm.__("Browse or upload media")) +
                      "\n                  "
                  )
                ])
              ]
