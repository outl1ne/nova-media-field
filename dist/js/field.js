...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    closeModalAndSave: function closeModalAndSave() {
      ...
      this.$emit('update:activeFile', _extends({}, this.stateActiveFile));
      this.$emit('update:isModalOpen', false);
    },
    ...
    fileBrowserSelectListener: function fileBrowserSelectListener(e) {
      ...
      try {
        for (var _iterator = Object.keys(this.$refs.uploadFiles.files)[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
          var fileKey = _step.value;
    ...
    dropEventListener: function dropEventListener(e) {
      ...
      try {
        for (var _iterator2 = Object.keys(e.dataTransfer.files)[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
