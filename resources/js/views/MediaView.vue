  ...
  >
    ...
    <div class="flex">
      ...
      >
        ...
        <media-index-button
          ...
          :multiple="false"
          :on-upload-finished="() => getResources()"
        />
      </div>
    </div>
    ...
    <card>
      <div
        class="flex items-center"
        :class="{
          'py-3 border-b border-50': shouldShowCheckBoxes || shouldShowDeleteMenu || softDeletes || !viaResource,
        }"
      >
...
export default {
  ...
  computed: {
    ...
    authorizedToDeleteAnyResources() {
      return this.resources.length > 0 && Boolean(_.find(this.resources, resource => resource.authorizedToDelete));
    },
    ...
    authorizedToForceDeleteAnyResources() {
      return this.resources.length > 0 && Boolean(_.find(this.resources, resource => resource.authorizedToForceDelete));
    },
    ...
    authorizedToRestoreAnyResources() {
      return this.resources.length > 0 && Boolean(_.find(this.resources, resource => resource.authorizedToRestore));
    },
    ...
    resourceCountLabel() {
      ...
      return (
        ...
        `${first + 1}-${first + this.resources.length} ${this.__('of')} ${this.allMatchingResourceCount}`
      );
    },
